...
document.getElementById("variableBtn").onclick = function () { selectTab("variableBtn", "variablesTab", true, "Here is your variales<br>You can add more Variables by buton.<br>For wariables to work you must hit save button.<br> Save button sorts variables and remove nonvalid ones."); }
