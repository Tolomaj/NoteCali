...
document.getElementById("variableBtn").onclick = function () { selectTab("variableBtn", "variablesTab", true, "You can add more Variables by buton.<br>Save button sorts variables and remove nonvalid ones.<br><span style='color:#c21111;'>For changes to be applied you must hit save button.</span>"); }
